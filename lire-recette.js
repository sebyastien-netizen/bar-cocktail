  ...
  try {
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'system',
          content: 'Tu es un extracteur de recettes de cocktails depuis des images. Lis le texte visible sur l\'image et extrais la recette. REGLES : recopie exactement les noms d\'ingredients tels qu\'ils apparaissent, sans traduire. Convertis toutes les quantites de volume en cl (ex: 45ml = 4.5cl). Si une quantite n\'est pas lisible ou pas un volume, mettre quantite: null et unite: null (vraies valeurs JSON null, jamais le texte "null"). Ne jamais inventer un ingredient absent de l\'image. Reponds UNIQUEMENT en JSON valide. Format : { "nom": "...", "ingredients": [{"nom": "...", "quantite": 4.5, "unite": "cl"}], "garniture": "...", "source": "..." } Si aucune recette lisible : { "nom": null, "ingredients": [] }'
        }, {
          role: 'user',
          content: [
